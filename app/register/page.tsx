                        ...
                        onChange={(e) => {
                          if (e.target.value === "") {
                            ...
                            setIncomeErrorMessage(
                              "Yearly income field cannot be empty"
                            );
                          } else if (
                            e.target.value !== "" &&
                        ...
                        onChange={(e) => {
                          if (e.target.value === "") {
                            ...
                            setGoalAmountMessage(
                              "Goal Amount field cannot be empty"
                            );
                          } else if (
                            e.target.value !== "" &&
                            !/^\d+$/.test(e.target.value)
              ...
              <Button
                ...
                onClick={(e) => {
                  ...
                  if (
                    ...
                    enqueueSnackbar("Sucessfully Registered!", {
                      variant: "success",
                    });
                    router.push("/login");
                  } else {
                    enqueueSnackbar(
                      "Please ensure all fields are properly filled and try submitting again",
                      { variant: "error" }
                    );
                  }
                }}
